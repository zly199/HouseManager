					...
					<form action="userselect.html" method="post" class="definewidth m20">
						<table class="table table-bordered table-hover definewidth m10">
							...
							<tr class="size">
								...
								<td>客户需求最小面积</td>
								<td><input type="text" name="minarea" /></td>
							</tr class="size">
							<tr class="size">
								<td>客户需求最大面积</td>
								<td><input type="text" name="maxarea" /></td>
								<td>客户需求物业ID</td>
								<td><input type="text" name="email" /></td>
							</tr>
							<tr class="size">
							...
							<tr class="size">
								<td>客户需求装修</td>
								<td>
									<input type="radio" name="optionsRadios2" value="是" />是 &nbsp; &nbsp;
									<input type="radio" name="optionsRadios2" value="否" checked />否
								</td>
								<td>客户需求房间数</td>
							...
							<tr class="size">
								<td>客户需求物业用途</td>
								<td><input type="text" name="using" /></td>
								<td>客户需求最小建成年份</td>
								<td>
