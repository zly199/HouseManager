...
-->
		...
		<link rel="stylesheet" type="text/css" href="media/css/tablemanager.css" />
							...
							<div class="span12">
								<div>
									<table id="Table" class="formdata" width="100%">
										<caption>HouseManager出租情况统计表</caption>
										<thead>
											<tr>
												<th>小区</th>
												<th>出租数量</th>
	...
	<![endif]-->
		...
		<script type="text/javascript" src="media/js/countrent.js"></script>
		<!-- END JAVASCRIPTS -->
